  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', gap: 24, alignItems: 'stretch' }}>
        <BarraTab
          tab={[
            { href: '/account/impostazioni-v2/app', label: t('tabApp'), icona: <IconaImpostazioni /> },
            { href: '/account/impostazioni-v2/fiscalita', label: t('tabFiscalita'), icona: <IconaFiscalita /> },
          ]}
        />
